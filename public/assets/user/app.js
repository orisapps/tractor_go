            ...
            if ($scope.data.serviceType === 'tractorization') {
                return items.reduce(function (items, item) {
                    ...
                    if (item.data.insurance)
                        description = item.data.quantity + ' "' + item.data.name + '" service(s) for "' + item.data.plan.plan_name + '" land at ' + formatCurrency(Number(item.data.plan.total_price)) + ' ' + item.data.plan.cycle + ' - with insurance at ' + formatCurrency(Number(insurance)) + ' per acre';
                    else
                        description = item.data.quantity + ' "' + item.data.name + '" service(s) for "' + item.data.plan.plan_name + '" land at ' + formatCurrency(Number(item.data.plan.total_price)) + ' ' + item.data.plan.cycle + ' - without insurance at '  + formatCurrency(Number(insurance)) + ' per acre';
